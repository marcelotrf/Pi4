...
public class ListarFuncionario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListarFuncionario</title>");
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException 
    {
        List<Usuario> listaFuncionários = UsuarioDao.getUsuario();
...
//        listaProdutos.add(statusALte);
        request.setAttribute("listaFuncionarios", listaFuncionários);
//     apagar   String nome = "joao";
//     apagara   request.setAttribute("ativar", nome);   

//        Dispacher vai apresentar o request na pagina jsp
        RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/listarFuncionario.jsp");
