...
public class AlterarFuncionario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario funcionario = UsuarioDao.getUsuario(nome);
        request.setAttribute("funcionarioJ",funcionario);  
        // mostrar na tela o request
        RequestDispatcher rd =
                getServletContext().getRequestDispatcher("/alterarFuncionario.jsp");
...
//        Criar informacoes recebidas em uma lista e adicionar para a classe produto
        Usuario funcionarioJsp = new Usuario(nome,senha,tipo,email);        
        try {
            UsuarioDao.atualizarFuncionario(funcionarioJsp);
